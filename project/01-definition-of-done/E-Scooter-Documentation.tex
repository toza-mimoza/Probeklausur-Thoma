...
\begin{figure} [htbp]
  \begin{center}
    \includegraphics[scale=0.75]{images/protocols/01-start-menu.png}
  \end{center}
  \caption{Start Menu}
\end{figure}
...
\begin{figure} [htbp]
  \begin{center}
    \includegraphics[scale=0.75]{images/protocols/01-01-start-menu--scan-qr-code.png}
  \end{center}
...
\begin{figure} [htbp]
  \begin{center}
    \includegraphics[scale=0.75]{images/protocols/01-02-start-menu---driving.png}
  \end{center}
...
\begin{figure} [htbp]
  \begin{center}
    \includegraphics[scale=0.75]{images/protocols/02-menu-dropdown.png}
  \end{center}
...
\begin{figure} [htbp]
  \begin{center}
    \includegraphics[scale=0.75]{images/protocols/02-01-menu-dropdown--account-management.png}
  \end{center}
...
\begin{figure} [htbp]
  \begin{center}
    \includegraphics[scale=0.75]{images/protocols/02-01-01-menu-dropdown--account-management--change-account-details.png}
  \end{center}
...
\begin{figure} [htbp]
  \begin{center}
    \includegraphics[scale=0.75]{images/protocols/02-02-menu-dropdown--payment-information.png}
  \end{center}
...
\begin{figure} [htbp]
  \begin{center}
    \includegraphics[scale=0.75]{images/protocols/02-02-01-menu-dropdown--payment-information--payment-methods.png}
  \end{center}
...
\begin{figure} [htbp]
  \begin{center}
    \includegraphics[scale=0.75]{images/protocols/02-02-01-01-menu-dropdown--payment-information--payment-methods--credit-debit-card-info.png}
  \end{center}
...
\begin{figure} [htbp]
  \begin{center}
    \includegraphics[scale=0.75]{images/protocols/02-02-01-02-menu-dropdown--payment-information--payment-methods--wallet.png}
  \end{center}
...
\begin{figure} [htbp]
  \begin{center}
    \includegraphics[scale=0.75]{images/protocols/02-03-menu-dropdown--check-drive-statistics.png}
  \end{center}
...
\begin{figure} [htbp]
  \begin{center}
    \includegraphics[scale=0.75]{images/protocols/02-04-menu-dropdown--check-spent-money.png}
  \end{center}
...
\begin{figure} [htbp]
  \begin{center}
    \includegraphics[scale=0.45]{images/protocols/02-05-menu-dropdown--other.png}
  \end{center}
...
\begin{figure} [htbp]
  \begin{center}
    \includegraphics[scale=0.75]{images/protocols/03-ask-for-feedback.png}
  \end{center}
...
\begin{figure} [htbp]
  \begin{center}
    \includegraphics[scale=0.75]{images/protocols/04-register-sign-up.png}
  \end{center}
...
\begin{figure} [htbp]
  \begin{center}
    \includegraphics[scale=0.75]{images/protocols/05-log-in.png}
  \end{center}
  \caption{Log in}
\end{figure}
...
\begin{figure} [htbp]
  \begin{center}
    \includegraphics[scale=0.75]{images/protocols/06-loading-screen.png}
  \end{center}
